  ...
  $.getJSON(patientsAPI).done(function(patients) {
	  ...
	  $.getJSON(roomsAPI).done(function(rooms1) {
		  ...
		  $('#patients-waiting').dataTable({
		       ...
		       columns: [{
		       	 title: "<span class=\"fa fa-hospital-o fa-fw\" style=\"color: black;\"></span>   " + "  T/R",
                     width: "30%"
		       }, {
		           title: "Kutayotgan Bemor",
                     width: "60%"
		       }, {
		           title: "Tezlik",
                     width: "10%"
		       ...
		       info: false,
                 language: {
                   searchPlaceholder: "Kutayotgan bemorlarni qidiruv...",
                   sSearch: ""
                 },
               aaSorting: [[2, 'desc']],
		  ...
		  $('#patients-in-hospital').DataTable({
		        ...
		        info: false,
                  language: {
                       searchPlaceholder: "Xonadagi bemorlar bo'yicha qidiruv...",
                       sSearch: ""
                },
                aaSorting: [[3, 'desc']],
                fnCreatedRow: function(nRow, aData, iDisplayIndex) {
		  ...
		  $('#free-rooms').dataTable({
			  ...
			  info: false,
                language: {
                     searchPlaceholder: "Xonalar qidiruv...",
                     sSearch: ""
              }
		  });
